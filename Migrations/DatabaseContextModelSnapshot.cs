...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassyAdsServer.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ClassyAdsServer.Entities.Message", b =>
                {
                    b.HasOne("ClassyAdsServer.Entities.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ClassyAdsServer.Entities.User", "Target")
                        .WithMany()
                        .HasForeignKey("TargetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ClassyAdsServer.Entities.User", null)
                        .WithMany("Messages")
                        .HasForeignKey("UserId");
